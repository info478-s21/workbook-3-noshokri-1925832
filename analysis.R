...
ggplot(data_2016) +
  ...
  labs(title = "DALYS vs HALE",
       x = "DALY",
       y = "HALE")
ggsave("charts/hale_vs_daly.png")
...
ggplot(data_wide) +
  ...
  labs(title = "Life Expectacny Difference vs HALE Difference",
...
# From this graph we can see that the majority of countries
# had an increase in HALEs and Life Expectancy between 1990
# and 2016. It also makes sense that the difference in
# HALE and Life Expectancies are positively correlated
# since we can see from our first graph that Life Expectancy
# and HALEs have a strong positve correlation